    ...
    <div className="container">
      ...
      <div className="body">
        <div className="content">
          ...
          <img className="picture" src="https://www.realsimple.com/thmb/FY7HYd6A6iRERlEOJzht8Vs8_GE=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/work-from-outdoors-tips-2000-1c4ee7641fd84a42a7878dcb2a1b62fe.jpg" alt="Picture" />
